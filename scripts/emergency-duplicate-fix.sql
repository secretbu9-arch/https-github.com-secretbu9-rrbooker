-- Emergency Duplicate Fix - Remove ALL duplicates immediately
...
-- Remove ALL duplicate notifications from the last 7 days
WITH duplicates AS (
  SELECT 
    id,
    ROW_NUMBER() OVER (
...
-- ============================================================================
-- STEP 2: CREATE STRICT DUPLICATE PREVENTION FUNCTION
-- ============================================================================
...
SELECT 'EMERGENCY DUPLICATE FIX APPLIED!' as status,
       'All duplicates removed' as cleanup,
       'Ultra-strict prevention functions created' as functions,
       'Centralized notification functions available' as centralized;
